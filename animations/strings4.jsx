...
{
  var terminalActions = " \
  input:ruby strings4.rb;\
  output:2: and I quote "Four score and twenty years ago" or something like that
\n";

  var editorText = 'puts 'and I quote "Four score and twenty years ago" or something like that'';
