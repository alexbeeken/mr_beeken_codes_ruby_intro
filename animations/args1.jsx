...

{
  var terminalActions = " \
  input:ruby args1.rb;\
  output:2: hello my name is Bob and I’m a human being! (probably)
\n";

  var editorText = 'def hello_message(name = "Bob")
  return "hello my name is #{name} and I’m a human being! (probably)"
end
