...
{
  var terminalActions = " \
  input:ruby interp8.rb;\
  output:2: hello I’m Alex and I spent 100 editing this video.
\n";

  var editorText = 'name = 'Alex'
hours = 100

puts 'hello I’m ' + name + ' and I spent ' + hours.to_s + ' editing this video.'';
